...
# image: unityci/editor:ubuntu-2019.3.28f1-android-0.11.0
# docker build -t ppartida/ubuntu-2022.3.28f1
FROM unityci/editor:ubuntu-2022.3.28f1-windows-mono-3.1.0
# ====
LABEL version="0.2.0" \
      description="Ubuntu with Unity docker 2022.3.28f1-ubuntu-mono-3.1.0 + Dot Net 5.0 for Unit Testing process" \
      tag1="Unity" \
      tag2=".NET" 
